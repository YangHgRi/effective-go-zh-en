...
+ **[Fork on GitHub](https://github.com/YangHgRi/effective-go-zh-en)**
+ 请顺手点一下 `STAR` ，或者留言讨论，这是对我最大的鼓励！

### 下载

为了让大家更方便阅读，在此提供 EPUB 格式的文件下载：

- [EPUB 格式](https://github.com/YangHgRi/effective-go-zh-en/releases/download/v0.0.1/Effective.Go.epub)
